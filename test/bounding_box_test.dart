...
void main() {
  group("BoundingBox", () {
    ...
    test("should calculate width and height", () {
      final bbox = BoundingBox(x0: 10, top: 20, x1: 110, bottom: 120);
    ...
    test("should check if contains another bbox", () {
      final bbox1 = BoundingBox(x0: 0, top: 0, x1: 100, bottom: 100);
      final bbox2 = BoundingBox(x0: 25, top: 25, x1: 75, bottom: 75);
      final bbox3 = BoundingBox(x0: 50, top: 50, x1: 150, bottom: 150);
    ...
    test("should check intersection", () {
      final bbox1 = BoundingBox(x0: 0, top: 0, x1: 100, bottom: 100);
      final bbox2 = BoundingBox(x0: 50, top: 50, x1: 150, bottom: 150);
      final bbox3 = BoundingBox(x0: 200, top: 200, x1: 300, bottom: 300);
    ...
    test("should return null for non-intersecting boxes", () {
      final bbox1 = BoundingBox(x0: 0, top: 0, x1: 100, bottom: 100);
      final bbox2 = BoundingBox(x0: 200, top: 200, x1: 300, bottom: 300);
    ...
    test("should convert to relative coordinates", () {
      final parent = BoundingBox(x0: 0, top: 0, x1: 200, bottom: 200);
      final child = BoundingBox(x0: 50, top: 50, x1: 150, bottom: 150);
    ...
    test("should convert to absolute coordinates", () {
      final parent = BoundingBox(x0: 0, top: 0, x1: 200, bottom: 200);
      final relative = BoundingBox(x0: 0.25, top: 0.25, x1: 0.75, bottom: 0.75);
